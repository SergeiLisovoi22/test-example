...
class TaskServiceTest {
    ...
    @Test
    @DisplayName("Test get task by title success")
    ...
    @Test
    @DisplayName("Test get task by title not found")
    void getTaskByTitleNoFound() {
        when(taskRepository.findByTitle("Jira001")).thenReturn(Optional.empty());

        assertThrows(TaskNotFoundException.class, () -> taskService.getTaskByTitle("Jira001"));

        verify(taskRepository, times(1)).findByTitle("Jira001");
    }

    @Test
    @DisplayName("Test get task by status success")
    ...
    @Test
    @DisplayName("Test get task by status not found")
    void getTaskByStatusNoFound() {
        when(taskRepository.findByStatus("CLOSED")).thenReturn(Optional.empty());

        assertThrows(TaskNotFoundException.class, () -> taskService.getTaskByStatus("CLOSED"));
    ...
    void createTaskSaveFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> taskService.createTask(inputDto));
